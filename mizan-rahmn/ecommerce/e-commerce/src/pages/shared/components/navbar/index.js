...
// //mport { MenuIcon, XIcon } from "@heroicons/react/outline";
...
//                                                         Open user menu
//                                                     </span>
//                                                     <div className="h-8 w-8 rounded-full bg-gradient-to-r from-yellow-200 to-red-400"></div>
//                                                 </Menu.Button>
//                                             </div>
//                                             <Transition
//                                                 show={open}
