...
export default function Navbar() {
   ...
   console.log(productInitialState.userInfo.user);
    return (
                                                        ...
                                                        (item, index) => (
                                                            ...
                                                            >
                                                                <NavLink
                                                                    ...
                                                                    className="p-4 text-gray-600 block text-base font-medium transform transition-all hover:scale-110 hover:shadow-md hover:bg-blue-400 hover:text-gray-700 rounded-lg"
                                                                >
                                                                    {item.name}
                                                                </NavLink>
                                                            </Menu.Item>
